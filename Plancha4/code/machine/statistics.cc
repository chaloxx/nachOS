...
Statistics::Statistics()
{
    ...
    numberOfTLBSearchs = numberOfPageFounds = 0;
#ifdef DFS_TICKS_FIX
    tickResets = 0;
#endif
...
Statistics::Print()
{
    ...
    printf("Searchs on TLB:%u\n",numberOfTLBSearchs);
    printf("Pages found in TLB:%u\n",numberOfPageFounds);    
    float a = numberOfTLBSearchs;
    float b = numberOfPageFounds;
    printf("Hit radio of TLB: %f\n",b/a);
}
