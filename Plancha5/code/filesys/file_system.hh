...
public:
    ...
    bool DirectoryExist(const char*);

    //Crea un directorio en el sector asignado y devuelve un openfile del mismo
    OpenFile* CreateDirectory(unsigned,Bitmap*,int df);
...
private:
    ...
    //Remueve todos los contenidos de un directorio ubicado en sector usando la ruta path
    void RemoveDirContents(const char* path,unsigned sector);			      
};
